...
import io.ffit.carbon.i18n4j.log.LoggingOutputStream;
 ...
 * <a href="https://gist.github.com/gists/831762/">https://gist.github.com/gists/831762/</a>
 */
public class ScriptRunner {
    ...
    private PrintWriter logWriter = new PrintWriter(new LoggingOutputStream(logger, LoggingOutputStream.LogLevel.DEBUG));
    private PrintWriter errorLogWriter = new PrintWriter(new LoggingOutputStream(logger, LoggingOutputStream.LogLevel.ERROR));
